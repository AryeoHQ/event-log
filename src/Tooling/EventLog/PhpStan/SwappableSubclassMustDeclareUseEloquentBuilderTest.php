...
/** @extends RuleTestCase<SwappableSubclassMustDeclareUseEloquentBuilder> */
#[CoversClass(SwappableSubclassMustDeclareUseEloquentBuilder::class)]
#[CoversClass(SwappableSubclasses::class)]
final class SwappableSubclassMustDeclareUseEloquentBuilderTest extends RuleTestCase
{
    use GetsFixtures;

    protected function getRule(): Rule
    {
        return new SwappableSubclassMustDeclareUseEloquentBuilder;
    }
    ...
    public function it_fails_when_the_subclass_omits_the_attribute(): void
    {
        $this->analyse([$this->getFixturePath('EventLog/SwappableSubclassWithoutAttributes.php')], [
            ['A '.class_basename(Swappable::class).' subclass must declare #['.class_basename(UseEloquentBuilder::class).'].', 9],
        ]);
    }
}
