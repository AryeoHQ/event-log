...
/** @extends RuleTestCase<SwappableSubclassMustDeclareCollectedBy> */
#[CoversClass(SwappableSubclassMustDeclareCollectedBy::class)]
#[CoversClass(SwappableSubclasses::class)]
final class SwappableSubclassMustDeclareCollectedByTest extends RuleTestCase
{
    use GetsFixtures;

    protected function getRule(): Rule
    {
        return new SwappableSubclassMustDeclareCollectedBy;
    }
    ...
    public function it_fails_when_the_subclass_omits_the_attribute(): void
    {
        $this->analyse([$this->getFixturePath('EventLog/SwappableSubclassWithoutAttributes.php')], [
            ['A '.class_basename(Swappable::class).' subclass must declare #['.class_basename(CollectedBy::class).'].', 9],
        ]);
    }
}
