...
namespace Tests\Fixtures\Support\Entities\DisablesModelSerializationThroughInterface;
...
class DisablesModelSerializationThroughInterface extends Model implements Loggable
{
    use AnnouncesToLog;
